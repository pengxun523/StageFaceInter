...
#define MAX_CVBUFFER_SIZE 10*1024
...
public:
	...
	void setCsTcpMsgLen(unsigned int uiLen)
	{
		unsigned int uiTempLen = htonl(uiLen);
		memcpy(m_Buffer,&uiTempLen, sizeof(unsigned int));
	}
